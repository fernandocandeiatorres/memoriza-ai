      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-6 md:mb-0">
            <Link href="/">
              <a className="flex items-center font-bold text-xl mb-4">
                <Brain className="mr-2 h-5 w-5" />
                memoriza<span className="text-accent">.ai</span>
              </a>
            </Link>
            <p className="text-gray-400 text-sm">
              AI-powered flashcards for medical students. Study smarter, not harder.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#features">
                  <a className="text-gray-400 hover:text-white text-sm">Features</a>
                </Link>
              </li>
              <li>
                <Link href="#">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#">
                  <a className="text-gray-400 hover:text-white text-sm">Blog</a>
                </Link>
              </li>
              <li>
                <Link href="#">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">© 2023 Memoriza.ai. All rights reserved.</div>
